...
public class Hiscore extends KaitaiStruct {
    ...
    public static class Package extends KaitaiStruct {
        ...
        public Package(KaitaiStream _io, Hiscore _parent) {
            this(_io, _parent, null);
        }

        public Package(KaitaiStream _io, Hiscore _parent, Hiscore _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Header extends KaitaiStruct {
        ...
        public Header(KaitaiStream _io, Hiscore.Package _parent) {
            this(_io, _parent, null);
        }

        public Header(KaitaiStream _io, Hiscore.Package _parent, Hiscore _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private Hiscore _root;
        private Hiscore.Package _parent;
        ...
        public Hiscore _root() { return _root; }
        public Hiscore.Package _parent() { return _parent; }
    }
    public static class DataBlock extends KaitaiStruct {
        ...
        public DataBlock(KaitaiStream _io, Hiscore.Package _parent) {
            this(_io, _parent, null);
        }

        public DataBlock(KaitaiStream _io, Hiscore.Package _parent, Hiscore _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
