...
trex_t::trex_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, trex_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    _read();
}
...
trex_t::link_t::link_t(kaitai::kstream* p__io, trex_t* p__parent, trex_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}

void trex_t::link_t::_read() {
    int l_packages = 4;
...
trex_t::package_t::package_t(kaitai::kstream* p__io, trex_t::link_t* p__parent, trex_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}
...
trex_t::header_t::~header_t() {
}

trex_t::additional_info_t::additional_info_t(kaitai::kstream* p__io, trex_t::link_t* p__parent, trex_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}

void trex_t::additional_info_t::_read() {
...
trex_t::additional_info_t::~additional_info_t() {
    delete m_header;
    delete m_data;
}
